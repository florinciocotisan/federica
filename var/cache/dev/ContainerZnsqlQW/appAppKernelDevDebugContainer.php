...
class appAppKernelDevDebugContainer extends Container
{
    ...
    {
        return $this->services['PrestaShop\\PrestaShop\\Adapter\\Category\\Repository\\CategoryRepository'] = new \PrestaShop\PrestaShop\Adapter\Category\Repository\CategoryRepository(($this->services['doctrine.dbal.default_connection'] ?? $this->getDoctrine_Dbal_DefaultConnectionService()), '');
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zvpnv9-E0R', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lDuLOrzwQR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'r118530wood_federica', 'user' => 'r118530wood_federica', 'password' => 'SW_[$DXgx+Qn', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/ps_checkout/src/Entity')]);
        $d->addExcludePaths([0 => (\dirname(__DIR__, 4).'/modules/ps_checkout/src/Entity/index.php')]);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/productcomments/src/Entity')]);
        $e->addExcludePaths([0 => (\dirname(__DIR__, 4).'/modules/productcomments/src/Entity/index.php')]);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).'/modules/psxdesign/src/Entity')]);
        $f->addExcludePaths([0 => (\dirname(__DIR__, 4).'/modules/psxdesign/src/Entity/index.php')]);
        ...
        $a->setNamingStrategy(($this->services['prestashop.database.naming_strategy'] ?? ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy(''))));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o4T0zb5L0q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XCaf+ug7sY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NthjEZgMSP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qMSI2nhvu-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Vw7kzbciwI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I-2XcIgKm3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oBpeARWhbv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o6EOdgZ0yw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JTMuizo6VO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1NW+Mpx6N9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W-LWhyhfW7', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d6aSVCLYZZCJP8MPSJvbSuEIhRCIfz5UAIgFd7EPeouLWCR3yX2b8AKD5y2zWUez'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                71 => 'statscarrier',
                72 => 'graphnvd3',
                73 => 'psxmarketingwithgoogle',
                74 => 'ps_metrics',
                75 => 'klaviyopsautomation',
                76 => 'ps_supplierlist',
                77 => 'statsbestmanufacturers',
                78 => 'lot_design',
                79 => 'lot_exportergoogle',
            ],
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => false,
            'database_host' => '127.0.0.1',
            'database_port' => '',
            'database_name' => 'r118530wood_federica',
            'database_user' => 'r118530wood_federica',
            'database_password' => 'SW_[$DXgx+Qn',
            'database_prefix' => '',
            ...
            'secret' => 'd6aSVCLYZZCJP8MPSJvbSuEIhRCIfz5UAIgFd7EPeouLWCR3yX2b8AKD5y2zWUez',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-05-13',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => '96BfwpuvZjZUhzVWazsU4Sjk9pZETSWuB8T8Zx6IZ3eSaw5Dn0w5c89L00NYKuVF',
            'cookie_iv' => 'vNWphcbyN44a8QGR5sLD0u9og2AEHpLM',
            'new_cookie_key' => 'def00000e1cd01bb1cb98fa5814f8d0323101f9b6cabb87073772a8fe35ed66ffacd13d3d1c994b90718e56cd45a605e99a06aa0e4c523a31641369650342ce79ea70320',
            ...
            'modules_translation_paths' => [
                ...
                34 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/ps_edition_basic/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                ...
                47 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                ...
                54 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/ps_mbo/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/ps_facebook/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/psxdesign/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/lot_design/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/lot_exportergoogle/translations'),
            ],
            ...
            'kernel.secret' => 'd6aSVCLYZZCJP8MPSJvbSuEIhRCIfz5UAIgFd7EPeouLWCR3yX2b8AKD5y2zWUez',

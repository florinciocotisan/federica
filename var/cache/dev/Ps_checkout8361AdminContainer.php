...
class Ps_checkout8361AdminContainer extends Container
{
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.1.5', '/home/r118530wood/federica.ecomdoo.eu', true);
    }
